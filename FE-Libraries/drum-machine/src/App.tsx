...
const sounds: { [key: string]: Sound } = {
  ...
  D: { sound: 'https://cdn.freecodecamp.org/testable-projects-fcc/audio/Dsc_Oh.mp3', description: 'Drums 1', audioRef: React.createRef<HTMLAudioElement | null>() },
  ...
  C: { sound: 'https://cdn.freecodecamp.org/testable-projects-fcc/audio/Cev_H2.mp3', description: 'Cymbal 1', audioRef: React.createRef<HTMLAudioElement | null>() },
};
